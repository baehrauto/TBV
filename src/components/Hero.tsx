      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            Secure Facility Construction & Consulting
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Trust But Verify Solutions specializes in SCIF construction, secure facility design, and federal compliance consulting. 
            We deliver mission-critical infrastructure with uncompromising security standards.
          </p>
